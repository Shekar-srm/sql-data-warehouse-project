...
Description :
    Creates tables in the silver schema for storing cleaned and
    transformed data from the bronze layer. Includes additional
    metadata column (dwh_create_date) for audit purposes.

WARNING:
    - This script will DROP existing tables in the silver schema.
    - All existing data in these tables will be permanently deleted.
    - Ensure required backups are taken before execution.
-----------------------------------------------------------------------
*/
